(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=`modulepreload`,t=function(e){return`/front_6th_chapter1-1/`+e},n={},r=function(r,i,a){let o=Promise.resolve();if(i&&i.length>0){let r=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}o=l(i.map(i=>{if(i=t(i,a),i in n)return;n[i]=!0;let o=i.endsWith(`.css`),s=o?`[rel="stylesheet"]`:``,l=!!a;if(l)for(let e=r.length-1;e>=0;e--){let t=r[e];if(t.href===i&&(!o||t.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${i}"]${s}`))return;let u=document.createElement(`link`);if(u.rel=o?`stylesheet`:e,o||(u.as=`script`),u.crossOrigin=``,u.href=i,c&&u.setAttribute(`nonce`,c),document.head.appendChild(u),o)return new Promise((e,t)=>{u.addEventListener(`load`,e),u.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${i}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(e=>{for(let t of e||[]){if(t.status!==`rejected`)continue;s(t.reason)}return r().catch(s)})};function i(){return`
  ...
  `}let o={isLoading:!1,product:null};async function s(){let e=new URLSearchParams(location.search),t=e.get(`productId`);t||x(y.PRODUCT);try{let e=await fetch(`/api/products/${t}`);if(!e.ok)throw Error(`네트워크 오류`);let n=await e.json();o.product=n,console.log(JSON.stringify(n,null,2))}catch(e){console.log(e)}finally{o.isLoading=!1}}async function c(){return o.isLoading||(o.isLoading=!0,o.product=null,await s()),o.isLoading?l():u()}c.afterRender=()=>{let e=document.querySelector(`#back-btn`);e&&e.addEventListener(`click`,()=>x(y.PRODUCT)),document.querySelectorAll(`.related-product-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.productId;x(`/product/detail?productId=${t}`)})})};function l(){return`
  ...
  `}function u(){let{product:e}=o;return`
    <div class="min-h-screen bg-gray-50">
      <header class="bg-white shadow-sm sticky top-0 z-40">
        <div class="max-w-md mx-auto px-4 py-4">
          <div class="flex items-center justify-between">
          ...
          <div class="p-4">
            ...
            <div>
              ...
              <div class="flex items-center mb-3">
                ...
                <span class="ml-2 text-sm text-gray-600">${e.rating} (${e.reviewCount||0}개 리뷰)</span>
              </div>
              <!-- 가격 -->
              <div class="mb-4">
  ...
  `}let d={isLoading:!1,error:null,products:[],total:0};async function f(){let e=new URLSearchParams(location.search);try{let t=await fetch(`/api/products?${e.toString()}`);if(!t.ok)throw Error(`네트워크 오류`);let n=await t.json();d.products=n.products,d.total=n.pagination.total||0,d.error=null}catch(e){d.error=e.message}finally{d.isLoading=!1}}async function p(){d.isLoading||(d.isLoading=!0,d.error=null,d.products=[],await f());let e=new URLSearchParams(location.search),t=e.get(`search`)||``,n=e.get(`limit`)||20,r=e.get(`sort`)||`price_asc`,i=e.get(`total`)||0,a={search:t,limit:n,sort:r,total:i};return d.isLoading?g():h(a)}p.afterRender=()=>{let e=document.getElementById(`search-input`),t=document.getElementById(`limit-select`),n=document.getElementById(`sort-select`),r=document.getElementById(`products-grid`);e&&e.addEventListener(`keydown`,e=>{if(e.key===`Enter`){let t=new URLSearchParams(location.search);t.set(`search`,e.target.value.trim()),t.set(`page`,1),x(`${location.pathname}?${t.toString()}`)}}),t&&t.addEventListener(`change`,e=>{let t=new URLSearchParams(location.search);t.set(`limit`,e.target.value),t.set(`page`,1),x(`${location.pathname}?${t.toString()}`)}),n&&n.addEventListener(`change`,e=>{let t=new URLSearchParams(location.search);t.set(`sort`,e.target.value),t.set(`page`,1),x(`${location.pathname}?${t.toString()}`)}),r&&r.addEventListener(`click`,e=>{let t=e.target.closest(`.product-image`);if(!t)return;let n=t.closest(`.product-card`),r=n?.dataset.productId;r&&x(`/product/detail?productId=${r}`)})};function m(){return d.products.map(e=>`<div
      id="product-list"
  ...
  >
    ...
    <div class="p-3">
      <div class="cursor-pointer product-info mb-3">
        ...
        <p class="text-lg font-bold text-gray-900">${e.lprice||0}원</p>
      </div>
      <!-- 장바구니 버튼 -->
      <button
        ...
        <div class="mb-6">
          <div>
            ...
            <div class="mb-4 text-sm text-gray-600">
              총 <span class="font-medium text-gray-900">${d.total||0}개</span>의 상품
            </div>
            <!-- 상품 그리드 -->
            <div class="grid grid-cols-2 gap-4 mb-6" id="products-grid">${m()}</div>
  ...
  `}const _=`/front_6th_chapter1-1`,v=e=>_+e,y={MAIN:`${_}/`,PRODUCT:`${_}/product`,PRODUCT_DETAIL:`${_}/product/detail`,CART:`${_}/cart`,ERROR:`${_}/error`},b={[y.MAIN]:p,[y.PRODUCT]:p,[y.PRODUCT_DETAIL]:c,[y.CART]:i,[y.ERROR]:a};async function x(e,t=!1){history[t?`replaceState`:`pushState`](null,``,v(e)),await S()}async function S(){let e=document.querySelector(`#root`),{pathname:t}=location,n=t.split(`?`)[0];console.log(n);let r=b[n]||a,i=await r();e.innerHTML=i,typeof r.afterRender==`function`&&r.afterRender()}window.addEventListener(`popstate`,()=>{S()});const C=()=>r(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-B1ua0W-q.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>e.start(t));function w(){S()}C().then(w);